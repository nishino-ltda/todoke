<template>
  <section class="home-hero d-flex align-center" data-cy="home-hero">
...
logStore.log('🏠 HomeHero updated with resistance/open-source message')
</script>
