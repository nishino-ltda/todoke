<template>
  <PartnerLayout>
    <div class="region-edit-page" data-cy="partner-region-edit">
      <div class="d-flex align-center mb-6">
        ...
        ></v-btn>
        <div>
          <h1 class="text-h4 font-weight-bold">{{ t('partner.regions.edit') }}</h1>
...
const form = useForm({
  ...
  active: props.region.status === 'active'
});
...
const submit = async () => {
  ...
  try {
    ...
    await partnerService.updateRegion(props.region.id, payload);
